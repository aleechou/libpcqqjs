...
exports.buffFromText = function (text){
...
exports.buffToText = function (buff){
    return buff.toJSON().reduce(function(str,byte){
        return str + (byte<16?"0":"") + byte.toString(16).toLowerCase() + " "
    },"").trim()
}
exports.compareBuff = function(a,b){
...
exports.encrypt = function (v, k){
    ...
    */
    ...
    var tr = new Buffer([0,0,0,0,0,0,0])
    var to = new Buffer([0,0,0,0,0,0,0])
